...
class CustomUserCreationForm(UserCreationForm):
    ...
    address2 = forms.CharField(label="建物名", max_length=20, required=False, widget=forms.TextInput(attrs={'class': '','placeholder': '例：キャンセビル'}) )
...
class CustomUserUpdateForm(forms.ModelForm):
    ...
    address2 = forms.CharField(
        ...
        max_length=40,
        required=False,
        widget=forms.TextInput(attrs={'placeholder': '例: キャンセビル'}),
        validators=[validate_street_address]  # 必要に応じてバリデータを追加
    )
